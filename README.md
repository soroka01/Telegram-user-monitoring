...
Монитор Telegram-профилей на Telethon и aiogram. Пользовательская Telethon-сессия читает профиль, а бот пишет админу о смене имени, фамилии, username, premium emoji status, описания, бизнес-графика, канала в профиле, аватарок и видимых подарков.
...
После первого успешного снимка монитор сохраняет `id/access_hash` и дальше старается следить за тем же аккаунтом, даже если username сменился.
